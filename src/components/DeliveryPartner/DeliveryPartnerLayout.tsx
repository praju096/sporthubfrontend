...
const DeliveryPartnerLayout = () => {
  ...
  const handleMerchantLogout = () => {
    ...
    toast.info("Delivery Partner Logged out");
  ...
  const navItems = [
    { path: '/deliverypartner/dashboard', icon: 'fa-chart-pie', label: 'Dashboard' },
    { path: '/deliverypartner/orders', icon: 'fa-shipping-fast', label: 'Orders' },
  ];
    ...
    <div className="container-fluid p-0 vh-100 bg-light position-relative">
          <header className="d-lg-none d-flex align-items-center bg-dark text-white p-3 sticky-top shadow-sm z-3">
            ...
            <h4 className="fw-bold mb-0 text-truncate">
              <i className="fas fa-building text-danger me-2"></i> SPORTHUB DELIVERY PARTNER
            </h4>
          </header>
